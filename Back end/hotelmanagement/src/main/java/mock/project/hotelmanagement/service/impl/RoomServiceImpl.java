...
public class RoomServiceImpl implements RoomService {
    ...
    public Boolean deleteRoom(RoomDto roomDto) {
        ...
        if (!optionalRoom.isPresent()) {
            throw new NotFoundException("Not found Room with Id: " + roomDto.getId());
        }
        Room room = converterServiceImpl.convertToEntity(roomDto, Room.class);
        room.setDeleted(Boolean.TRUE);
