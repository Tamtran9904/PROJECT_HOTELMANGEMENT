...
public class RoomController {
    ...
    public DataResponse deleteRoomById(@RequestBody RoomDto roomDto) {
        return new DataResponse(null, "Successfully delete Room !", roomServiceImpl.deleteRoom(roomDto), 203);
    }
}
